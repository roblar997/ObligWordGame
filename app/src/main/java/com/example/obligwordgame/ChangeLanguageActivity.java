...
public class ChangeLanguageActivity extends AppCompatActivity {
    ...
    protected boolean addPoint(TextView pointView){
        ...
        if(points == 10){
            Intent intent=new Intent(ChangeLanguageActivity.this,GoalActivity.class);
    ...
    protected void setResponse(TextView placeholder, String message,int responseType){
        ...
        switch (ChangeLanguageActivity.responseType.values()[responseType]) {
    ...
    protected void setup(){
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(ChangeLanguageActivity.this,WordFoundActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.changeDifficulty:
                Intent changedifficultyIntent = new Intent(ChangeLanguageActivity.this,ChangeDifficultyActivity.class);
